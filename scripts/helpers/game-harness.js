...
function createHarness({ browserView = false, pathname = '/', storage = new Map() } = {}) {
    ...
    for (const file of [
        ...
        'systems/BattleActionSystem.js', 'systems/BattleReviewSystem.js', 'systems/SaveGameSystem.js', 'systems/ScenarioEventSystem.js',
    ...
    const api = vm.runInContext('({ Game, GameStorage, CampaignProgressSystem, HexGrid, Unit, UnitFactory, Scenarios, ScenarioManager, SaveGameSystem, ScenarioEventSystem, BattleReviewSystem, AI, BattleView, BattlePanels, BattleTooltip, BattleMapInput, BattleOrders, ThreeBattleMapView })', context);
