...
| `infantry_handgun` | Shared body with side-colour coat, helmet, tiller-mounted hand cannon, match cord and neutral ochre powder flask |
| `infantry_shield` | Shared body with side-colour coat, curved striped shield and raised sword for mercenaries |
