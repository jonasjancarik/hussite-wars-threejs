...
- Na dotyku a v okně do 1200 px: vyberte vlastní oddíl a klepněte na dostupné
  pole. Přesun, pochod hradby i útok na červeně zvýrazněného nepřítele se provedou
  rovnou, bez dalšího potvrzení. Nepřítele mimo dosah lze prohlížet bez útoku
  a vyčerpaný vlastní oddíl bez nového rozkazu. Klepnutí na dostupné prázdné pole
  už není inspekce.
...
- Konec tahu jedná rovnou i v kompaktním režimu. Nevyužité akce oddílů se přitom
  automaticky převedou na obranu. Escape zavře informační kartu, pak funguje běžná pauza.
...
Otevřená inspekce místa, kamera a historie undo se do savu neukládají.
...
1. iPhone/Safari a Android/Chrome: menu, briefing, první výběr, přímý pohyb,
   přímý útok, obrana, undo a přímý konec tahu.
...
5. Sbalování systémových lišt, zvětšené písmo a okraje displeje. Cíle, karta
   jednotky a Konec tahu musí zůstat dosažitelné.
...
přímý přesun, pochod, útok i konec tahu, souřadnice/zoom, gesta a duplicitní click,
